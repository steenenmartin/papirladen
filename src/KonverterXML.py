    ...
    for file in xml_files:
        ...
        try:
            ...
            if pakkeshop_id.isdigit():
                ...
                ET.SubElement(delivery_info, "DELIV_NAME").text = input_xml.get_element_by_tag_name("company", lambda x: x.parentNode.tagName == "shipping-address") if input_xml.get_element_by_tag_name("company", lambda x: x.parentNode.tagName == "shipping-address") != "" else input_xml.get_element_by_tag_name("name", lambda x: x.parentNode.tagName == "shipping-address")
                ET.SubElement(delivery_info, "DELIV_COMPANY").text = ""
                ...
                ET.SubElement(delivery_info, "DELIV_ADDRESS_2").text = input_xml.get_element_by_tag_name("phone", lambda x: x.parentNode.tagName == "shipping-address").replace(" ", "") + " " + input_xml.get_element_by_tag_name("name", lambda x: x.parentNode.tagName == "shipping-address")
